...
mongoose.connect("mongodb+srv://ripeplantain:pc4emmanuel2@cluster0.mya5s.mongodb.net/todolistDB", {
...
app.post("/delete", function (req, res) {
  ...
  if (listName === "Today") {
    Item.findByIdAndRemove(checkedId,(err,deleteItem)=> {
      if(err){
        console.log(err);
      } else {
